...
public class ManagerTreausure : MonoBehaviour
{
    // Start is called before the first frame update public Text time_txt;
    ...
    void Update()
    {
        ...
        score_txt.text = "SCORE:" + score;
         treasure = gameObject.GetComponent<Rotate>().treasure;
        treasure_txt.text = treasure.ToString();
    }
}
